...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "ki") || (event.body.toLowerCase() == "re")) {
     return api.sendMessage("-নাটক বুঝো আবেগ বুঝোনা.!🥲🤰", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Gdm9") || (event.body.toLowerCase() == "Good morning")) {
  ...
  if ((event.body.toLowerCase() == "Atick") || (event.body.toLowerCase() == "Atick bai") || (event.body.toLowerCase() == "Atick") || (event.body.toLowerCase() == "Halarpot")) {
   ...
   if ((event.body.toLowerCase() == "Owner") || (event.body.toLowerCase() == "Ceo")) {
     return api.sendMessage("ATICK", threadID);
   };

   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "Admin Ke")) {
     return api.sendMessage("My Creator:ATICK ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস উল্লাস আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "Admin") || (event.body.toLowerCase() == "Boter Admin")) {
     return api.sendMessage("He is ATICK❤️ তাকে সবাই Atick নামে চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu Alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "@পিচ্চি মেয়ে সামিরা") || (event.body.toLowerCase() == "@Šiḿu Ẫḱtễř")) {
     return api.sendMessage("খবরদার কেউ এই আইড়ি মেনশন দিবানা এটা আমার বস ATICK এর বউ এর আইড়ি😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "@Ahmed'z Fa'ru") || (event.body.toLowerCase() == "@Mst Riya Akter ")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস ATICK এর বউ এর নাম..!😠🥰⛏️", threadID);
   };
  
  if ((event.body.toLowerCase() == "@Nusrat Fariya") || (event.body.toLowerCase() == "Mim")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস ATICK এর বউ এর নাম..!😠🥰⛏️", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "Nafij") || (event.body.toLowerCase() == "@Eva Islam")) {
   ...
   if ((event.body.toLowerCase() == "AMAKE KEW VALOBASHE NA") || (event.body.toLowerCase() == "Amake kew valobashe na") || (event.body.toLowerCase() == "Aj kew nai bole")) {
     return api.sendMessage("️চিন্তা করো কেন আমি তো আছি🫶/nতোমাকে রাইতে ভালোবাসবো","— পাশে থাকলে, খাটে পাবেন ধন্যবাদ 👀🥱🧘‍♀️🚶‍♀️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "ami ATICK") || (event.body.toLowerCase() == "kire")) {
